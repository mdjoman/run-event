...
<head>
    ...
    <title>@yield('title', 'Admin - Run Burjowan')</title>
    ...
    <aside class="w-64 bg-sidebar text-white flex flex-col fixed h-full z-40">
        <div class="p-5 border-b border-slate-700">
            <a href="{{ route('admin.dashboard') }}" class="flex items-center gap-3">
                <img src="{{ asset('img/logo.png') }}" class="h-10 w-10 object-contain bg-white rounded-full p-1" alt="">
                <div class="">
        ...
        <header class="bg-white shadow-sm border-b border-slate-200 sticky top-0 z-30">
            <div class="px-6 py-4 flex items-center justify-between">
                <div>
                    ...
                    <p class="text-sm text-slate-500">@yield('page-subtitle', 'Welcome back, Admin')</p>
                </div>
