                ...
                @if ($active_event = $events->where('status', 'active')->first())
                    <div class="unique-card" style="flex-shrink: 0;">
                        <div class="event-img" style="padding-top: 2px;">
                            ...
                            <img src="{{ asset($active_event->image) }}" alt="Event" onclick="openIndexModal()" style="cursor: pointer; height: 197px;">
                        ...
                        <div class="event-content">
                            ...
                            <div class="action-buttons">
                                {{-- Share Button --}}
                                <a href="javascript:void(0)" class="btn-primary shareBtn" data-url="{{ route('form', $active_event->id) }}" data-title="{{ $active_event->title }}">
                    ...
                    <div class="unique-track" style="display: flex; gap: 20px; width: max-content;">
                        ...
                        <div class="unique-card" style="flex-shrink: 0;">
                            <div class="event-img">
                                ...
                                <img src="{{ asset('img/ur2.jpeg') }}" alt="Event" onclick="openIndexModal()" style="cursor: pointer;">
                                <div class="date-badge">
