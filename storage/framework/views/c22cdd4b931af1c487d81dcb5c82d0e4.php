<?php $__env->startSection('body'); ?>
    ...
    <section class="ab-journey-section">
        ...
        <div class="ab-journey-img-container fade-in">
            <img src="<?php echo e(asset('img/journey.jpg')); ?>" alt="Sirajganj Running Community" class="ab-brush-img">
        </div>
    </section>
...
<?php echo $__env->make('master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\run-event\resources\views/about.blade.php ENDPATH**/ ?>