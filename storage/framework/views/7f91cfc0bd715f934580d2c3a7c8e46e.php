        ...
        <div class="container hero-content">
            ...
            <div class="hero-btns">
                ...
                <?php if($active_event): ?>
                    ...
                    data-event_id="<?php echo e($active_event->id); ?>">Register Now <i class="fa-solid fa-arrow-right"></i></a>
                <?php endif; ?>
                ...
                <?php if($active_event): ?>
                    <div class="unique-card" style="flex-shrink: 0;">
                        <div class="event-img" style="padding-top: 3px; position: relative;">
                            ...
                            <img src="<?php echo e(asset($active_event->image)); ?>" alt="Event" onclick="openIndexModal()" style="cursor: pointer; height: 197px; width: 100%; object-fit: cover;">
                        ...
                        <div class="event-content">
                            <h3 onclick="openIndexModal()" style="cursor: pointer;"><?php echo e($active_event->title); ?></h3>
                            ...
                            <?php if($active_event->status == 'active'): ?>
                                <div class="action-buttons" style="display: flex; gap: 10px; width: 100%;">
                                    ...
                                    <a href="javascript:void(0)" class="btn-primary shareBtn" style="flex: 1; flex-basis: 0; text-align: center; justify-content: center; box-sizing: border-box; white-space: nowrap;" data-url="<?php echo e(route('form', $active_event->id)); ?>" data-title="<?php echo e($active_event->title); ?>">
                                        Share <i class="fa-solid fa-share-nodes"></i>
                                    </a>

                                    
                                    <a href="#" class="btn-primary proceedRegistrationBtn" style="flex: 1; flex-basis: 0; text-align: center; justify-content: center; box-sizing: border-box; white-space: nowrap;" data-title="<?php echo e($active_event->title); ?>" data-price="<?php echo e($active_event->fee); ?>" data-event_id="<?php echo e($active_event->id); ?>">
                    ...
                    <div class="unique-track" style="display: flex; gap: 20px; width: max-content;">
                        ...
                        <div class="unique-card" style="flex-shrink: 0;">
                            <div class="event-img">
                                ...
                                <img src="<?php echo e(asset($event->image)); ?>" alt="<?php echo e($event->title); ?>" onclick="openIndexModal()" style="cursor: pointer;">
                                <div class="date-badge">
                            ...
                            <div class="event-content">
                                <h3 onclick="openIndexModal()" style="cursor: pointer;"><?php echo e($event->title); ?></h3>
...
<?php echo $__env->make('master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\run-event\resources\views/index.blade.php ENDPATH**/ ?>