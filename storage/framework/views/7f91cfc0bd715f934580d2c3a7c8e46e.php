    ...
    <section class="events-section">
        <div class="container">
            ...
            <div class="unique-slider-wrap" style="display: flex; gap: 20px; align-items: center; overflow: hidden;">
                <?php if($active_event = $events->where('status', 'active')->first()): ?>
                    <div class="unique-card" style="flex-shrink: 0;">
                        <div class="event-img" style="padding-top: 2px;">
                            
                            <img src="<?php echo e(asset($active_event->image)); ?>" alt="Event" onclick="openIndexModal()" style="cursor: pointer; height: 197px;">
                        ...
                        <div class="event-content">
                            ...
                            <div class="action-buttons">
                                ...
                                <a href="javascript:void(0)" class="btn-primary shareBtn" data-url="<?php echo e(route('form', $active_event->id)); ?>" data-title="<?php echo e($active_event->title); ?>">
                    ...
                    <div class="unique-track" style="display: flex; gap: 20px; width: max-content;">
                        ...
                        <div class="unique-card" style="flex-shrink: 0;">
                            <div class="event-img">
                                ...
                                <img src="<?php echo e(asset('img/ur2.jpeg')); ?>" alt="Event" onclick="openIndexModal()" style="cursor: pointer;">
                                <div class="date-badge">
                    ...
                    <div class="lower-grid">
                        ...
                        <div class="panel">
                            ...
                            <div class="award-intro">
                                <strong>
                                    <span class="pink">21.1K, 15K & 7.5K</span>
                                </strong>
                                <br>
