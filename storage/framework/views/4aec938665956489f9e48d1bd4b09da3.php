            ...
            <div class="row align-items-end">
                <div class="col-lg-7 col-md-6 pb-4" style="padding-bottom: 4.8rem !important;">
                    ...
                    <div class="breadcrumb-custom">
                        <a href="<?php echo e(url('/')); ?>">Home</a> <i class="fa-solid fa-chevron-right mx-1 fs-6"></i> <span>Contact Us</span>
                    </div>
                </div>
                <div class="col-lg-5 col-md-6 text-center text-md-end">
                    <div class="hero-img-box">
                        <img src="<?php echo e(asset('img/tyres/tt.png')); ?>" alt="Tyre Image" class="img-fluid slide-from-right">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row g-3">
                ...
                <div class="col-lg-3 col-md-12">
                    <div class="assistance-card">
                        <img src="<?php echo e(asset('img/contact2.png')); ?>" alt="Headphone" class="headphone-img">
...
<?php echo $__env->make('master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\hayat-tyers\resources\views/contact.blade.php ENDPATH**/ ?>