    ...
    <section class="gallery-section container">
        ...
        <div class="gallery-grid">
            ...
            <div class="gallery-item" data-category="marathon">
                <img src="<?php echo e(asset('img/ur1.jpeg')); ?>" alt="Marathon">
            ...
            <div class="gallery-item" data-category="community">
                <img src="<?php echo e(asset('img/ur2.jpeg')); ?>" alt="Marathon">
                <div class="gallery-caption">
                    <i class="fa-regular fa-calendar"></i>
                    <div>
                        <h4>Sirajganj Marathon 2026</h4>
            ...
            <!-- Item 3 -->
            <div class="gallery-item" data-category="marathon">
                <img src="<?php echo e(asset('img/ur3.jpeg')); ?>" alt="Marathon">
                <div class="gallery-caption">
                    <i class="fa-regular fa-calendar"></i>
                    <div>
                        <h4>Sirajganj Marathon 2026</h4>
            ...
            <div class="gallery-item" data-category="awards">
                <img src="<?php echo e(asset('img/ur4.jpeg')); ?>" alt="Marathon">
                <div class="gallery-caption">
                    <i class="fa-regular fa-calendar"></i>
                    <div>
                        <h4>Sirajganj Marathon 2026</h4>
            ...
            <!-- Item 5 -->
            <div class="gallery-item" data-category="marathon">
                <img src="<?php echo e(asset('img/ur5.jpeg')); ?>" alt="Marathon">
                <div class="gallery-caption">
                    <i class="fa-regular fa-calendar"></i>
                    <div>
                        <h4>Sirajganj Marathon 2026</h4>
            ...
            <div class="gallery-item" data-category="marathon">
                <img src="<?php echo e(asset('img/ur6.jpeg')); ?>" alt="Marathon">
                <div class="gallery-caption">
                    <i class="fa-regular fa-calendar"></i>
                    <div>
                        <h4>Sirajganj Marathon 2026</h4>
...
<?php echo $__env->make('master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\run-event\resources\views/gallery.blade.php ENDPATH**/ ?>